...
public class NeuralNetwork implements Serializable {
	...
	/* get genome, 
		-functie de teruggeeft wat de weigts zijn van iedere neuron
		- aantal input nodes, hidden nodes per hidden layer 
		- ouputnodes,
		- misschien ook welke input values dit netwerk neemt, zo kunnen we het aantal nodes met welke waardes varieren .
		-
	*/
}

...
public class NeuralNetWorks {
	...
	public Matrix createTargetVectorAcc(String[] splits) {
		double[] targetValueAcc = {Double.parseDouble(splits[21])}; // value for speed in the data
	...
	public static void main(String[] args) throws IOException {
		...
		helper2.train_data = helper.getInputFile(helper2.infile);
		...
		try {
			...
			helper2.myNNAcc.buildHiddenLayer(34, "tanh");
			helper2.myNNAcc.buildOutputLayer(1, "tanh");
			helper2.myNNAcc.setLearningRate(0.01);
		}
		...
		helper2.train_data = helper.getInputFile(helper.infile);
		MSEAcc = helper2.trainNeuralNetworkAcc();
		System.out.println("MSEAcc " + Double.toString(MSEAcc) + " epochs " + helper.epochs);
		helper2.storeNNAcc(helper.myNNAcc, helper.mem_acc_nn);
		...
		helper2.train_data = helper2.getInputFile(helper.infileTest);
		MSEAcc = helper.testNN(helper2.myNNAcc);
		System.out.println("MSE " + Double.toString(MSEAcc) + " epochs " + helper2.epochs);

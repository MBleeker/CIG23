...
public class DefaultDriver extends AbstractDriver {
	...
	public String output_dir = (String)"";
			//"C:\\Users\\ali_e_000\\IdeaProjects\\TORCS-Race-Competititon\\src\\main\\java\\Maurits\\";
	String nn_mem_file_steer = (String)"steering_nn.mem";
	String nn_mem_file_acc = (String)"nn_accelerate.mem";
	Boolean useNN;
	Boolean trainNN;
	int epochs = 0;
	...
	public DefaultDriver() {
		...
		String filename = output_dir + (String)"train_nn_data.dat";
	...
	public NeuralNetwork loadNN(String inFile) {
		...
		System.out.println((String)inFile);
